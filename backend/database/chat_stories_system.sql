-- ========================================
-- NEURAL CHAT - CHAT & STORIES SYSTEM
-- Database Schema
-- ========================================
...
CREATE TABLE IF NOT EXISTS messages (
    ...
    receiver_id INT NULL, -- NULL for group chat
    character_id INT NULL, -- For character messages
...
CREATE TABLE IF NOT EXISTS calls (
    ...
    call_content TEXT, -- For call transcripts
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    INDEX idx_character (character_id),
...
CREATE TABLE IF NOT EXISTS stories (
    id INT PRIMARY KEY AUTO_INCREMENT,
    character_id INT NULL, -- NULL for main story
...
CREATE TABLE IF NOT EXISTS chat_rooms (
    ...
    character_id INT NULL, -- For private chats with characters
    user_id INT NULL, -- For private chats between users
...
-- Insert default character profile for test user
...
CREATE TABLE IF NOT EXISTS story_choices (
    ...
    affinity_change JSON, -- {"leo": 3, "chloe": -1}
